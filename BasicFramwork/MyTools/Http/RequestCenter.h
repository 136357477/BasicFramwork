...
//post 没有网络提示
- (void)sendRequestNohudPostUrl:(NSString *)myUrl
                         andDic:(NSDictionary *)info_dic setSuccessBlock:(void (^)(NSDictionary *resultDic))success_block setFailBlock:(void (^)(NSString *errorStr))fail_block;
...
- (void)sendRequestImageUrl:(NSString *)myUrl andImage:(UIImage *)image setSuccessBlock:(void (^)(NSDictionary *resultDic))success_block setFailBlock:(void (^)(NSString *errorStr))fail_block ;
